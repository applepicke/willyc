...
set :application, "willyc"
set :repo_url, "git@github.com:applepicke/willyc-v2.git"
set :deploy_to, '/home/applepicke/apps/willyc'
...
task :restart_app do
  on roles(:app) do
    execute "supervisorctl -c /home/applepicke/supervisor.conf restart willyc"
  end
end
